			...
			<div class="row align-items-center text-center">
				<div class="col-md-12">
					<div class="card-body">
						...
						<form action="../controler/auth-signin-traitement.php" method="POST">
						...
						<div class="form-group text-left mt-2">
							<div class="form-check">
								<input class="form-check-input" type="checkbox" id="flexCheckChecked" checked name="stayConnected">
								<label class="form-check-label" for="flexCheckChecked">
									 	 Resté connecté
								</label>
							</div>
						</div>
						<input class="btn btn-block btn-primary mb-4" type="submit" value="Connexion">
						<p class="mb-0 text-muted">Vous n'avez pas de compte? <a href="auth-signup.html" class="f-w-400">S'inscrire</a></p>
					</form>
					</div>
				</div>
			</div>
